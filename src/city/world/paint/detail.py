...
from ..assets.terrain_primary import DetailKey
...
VD_PURE_MIX = VoroniDistro(
	choice_weight_zip=(
		(GRASS_PLANT_A, 0.0625),
		(GRASS_PLANT_B, 0.0625),
		(GRASS_PLANT_C, 0.0625),
		(GRASS_TEXTURE_A, 0.0625),
		(GRASS_TEXTURE_B, 0.0625),
		(GRASS_TEXTURE_C, 0.0625),
		(GRASS_TEXTURE_D, 0.0625),
		(GRASS_LOG_A, 0.0625),
		(GRASS_LOG_B, 0.0625),
		(GRASS_ROCK_A, 0.0625),
		(GRASS_ROCK_B, 0.0625),
		(GRASS_FLOWER_A, 0.0625),
		(GRASS_FLOWER_B, 0.0625),
		(GRASS_FLOWER_C, 0.0625),
		(GRASS_FLOWER_D, 0.0625),
		(GRASS_FLOWER_E, 0.0625),
	)
)
...
VD_PLANT_MIX = VoroniDistro(
	choice_weight_zip=(
		...
		(GRASS_PLANT_B, 0.083),
		(GRASS_PLANT_C, 0.083),
		(GRASS_TEXTURE_A, 0.083),
		(GRASS_TEXTURE_B, 0.083),
		(GRASS_TEXTURE_C, 0.083),
		(GRASS_TEXTURE_D, 0.083),
		(GRASS_FLOWER_A, 0.083),
		(GRASS_FLOWER_B, 0.083),
		(GRASS_FLOWER_C, 0.083),
		(GRASS_FLOWER_D, 0.083),
		(GRASS_FLOWER_E, 0.083),
	)
)
...
VD_GRASS_TEXTURE = VoroniDistro(
	choice_weight_zip=(
		(GRASS_TEXTURE_A, 0.25),
		(GRASS_TEXTURE_B, 0.25),
		(GRASS_TEXTURE_C, 0.25),
		(GRASS_TEXTURE_D, 0.25),
	)
)
...
VD_GREEN_MIX = VoroniDistro(
	choice_weight_zip=(
		(GRASS_PLANT_A, 0.1429),
		(GRASS_PLANT_B, 0.1429),
		(GRASS_PLANT_C, 0.1429),
		(GRASS_TEXTURE_A, 0.1429),
		(GRASS_TEXTURE_B, 0.1429),
		(GRASS_TEXTURE_C, 0.1429),
		(GRASS_TEXTURE_D, 0.1429),
	)
)

VORONI_CHOICES = [
	VD_PURE_MIX, VD_PLANT_MIX, VD_FLOWER_FIELD, VD_GRASS_TEXTURE,
	VD_FELLED_WOOD, VD_GREEN_MIX
]
