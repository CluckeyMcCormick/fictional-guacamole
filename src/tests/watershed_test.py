...
def run():
    ...
    gennies = [
        ...
        # generator.PerpendicularGenerator(1, 1, (0, IMAGE_SIZE), val_range=(VALUE_MIN, VALUE_MAX))
        # generator.RadialGenerator( (0, 0), radius=600, rad_range=(-0.5, 0.5) )
    ]

    genny_count = len(gennies)
