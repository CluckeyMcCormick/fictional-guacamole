...
onready var range_bar = $BoxMargins/BoxDivider/RangeMaster/RangeBar
onready var fire_master = $BoxMargins/BoxDivider/FireMaster
onready var payload_master = $BoxMargins/BoxDivider/PayloadMaster
...
func register_range_change(target_node, target_function):
    range_bar.connect("value_changed", target_node, target_function)