...
const TM_PINE_A = preload("res://terrain/trees/mat_ztree01_fc_a.tres")
const TM_PINE_B = preload("res://terrain/trees/mat_ztree01_fc_b.tres")
const TM_PINE_C = preload("res://terrain/trees/mat_ztree01_fc_c.tres")
